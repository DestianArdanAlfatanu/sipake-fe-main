...
const SuspensionConsultationHistoriesPage = () => {
    ...
    const fetchHistories = async () => {
        try {
            ...
            const response = await axios.get("/suspension-consultations/histories", {
            ...
            <Card className="border border-gray-200 shadow-sm">
                <CardHeader className="pb-4">
                    <div className="flex items-center gap-2">
                        ...
                        <CardTitle className="text-lg font-semibold">Riwayat Konsultasi Kaki-Kaki</CardTitle>
                    </div>
                    <CardDescription className="text-xs">
                        Daftar riwayat diagnosa masalah suspensi BMW E36 Anda
                    </CardDescription>
                </CardHeader>
                <CardContent>
                    {error ? (
                                            ...
                                            >
                                                ...
                                                <TableCell className="text-center">
                                                    <Button
                                                        ...
                                                        className="text-emerald-600 hover:text-emerald-800 hover:bg-emerald-50 text-xs h-7 px-2"
