    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <div>
                    <h1 className="text-xl md:text-3xl font-bold text-gray-900">Undercarriage Symptoms</h1>
                    <p className="text-sm text-gray-600 mt-1 md:mt-2">Manage undercarriage symptom database</p>
                </div>
                <Button
                    onClick={() => {
