...
export default function SuspensionProblemsPage() {
    ...
    const fetchProblems = async () => {
        try {
            ...
            const response = await axios.get('/admin/suspension/problems', {
    ...
    const handleDelete = async (id: string) => {
        ...
        try {
            ...
            await axios.delete(`/admin/suspension/problems/${id}`, {
                headers: { Authorization: `Bearer ${token}` },
            });
    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <div>
                    <h1 className="text-xl md:text-3xl font-bold text-gray-900">Undercarriage Problems</h1>
                    <p className="text-sm text-gray-600 mt-1 md:mt-2">Manage undercarriage problem database</p>
                </div>
                <Button
                    onClick={() => {
...
function ProblemModal({
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (problem) {
                await axios.put(`/admin/suspension/problems/${problem.id}`, formData, {
                    headers: { Authorization: `Bearer ${token}` },
                });
                alert('Problem updated successfully!');
            } else {
                await axios.post('/admin/suspension/problems', formData, {
                    headers: { Authorization: `Bearer ${token}` },
                });
