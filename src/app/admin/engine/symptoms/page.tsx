...
export default function EngineSymptomsPage() {
    ...
    const fetchSymptoms = async () => {
        try {
            ...
            const response = await axios.get('/admin/engine/symptoms', {
    ...
    const handleDelete = async (id: string) => {
        ...
        try {
            ...
            await axios.delete(`/admin/engine/symptoms/${id}`, {
                headers: { Authorization: `Bearer ${token}` },
            });
...
function SymptomModal({
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (symptom) {
                await axios.put(`/admin/engine/symptoms/${symptom.id}`, formData, {
                    headers: { Authorization: `Bearer ${token}` },
                });
                alert('Symptom updated successfully!');
            } else {
                await axios.post('/admin/engine/symptoms', formData, {
                    headers: { Authorization: `Bearer ${token}` },
                });
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <Card className="w-full max-w-2xl max-h-[90vh] overflow-y-auto">
                <CardHeader>
                    ...
                    <CardDescription>
                        {symptom ? 'Update symptom information' : 'Create a new engine symptom'}
                    </CardDescription>
                </CardHeader>
                <CardContent>
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                placeholder="e.g., Gejala yang muncul saat mesin dihidupkan"
                            />
                        </div>
